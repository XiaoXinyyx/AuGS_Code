...
def rasterize_to_pixels(
    ...
    Returns:
        ...
        - **Depth index**. [C, image_height, image_width, 1].
        - **Is used**. [C, N]
    """
    ...
    render_colors, render_alphas, depth_idx, is_used = _RasterizeToPixels.apply(
        means2d.contiguous(),
        conics.contiguous(),
        colors.contiguous(),
    ...
    return render_colors, render_alphas, depth_idx, is_used
...
class _RasterizeToPixels(torch.autograd.Function):
    ...
    def forward(
        ...
        render_colors, render_alphas, last_ids, depth_idx, is_used = _make_lazy_cuda_func("rasterize_to_pixels_fwd")(
            means2d,
            conics,
            colors,
            opacities,
